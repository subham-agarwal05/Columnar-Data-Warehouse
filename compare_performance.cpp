...
int main() {
    ...
    out << "<!DOCTYPE html><html><head><title>Performance Comparison</title>"
        << "<style>"
        << "body{font-family: Arial, sans-serif; margin: 40px; background-color:#f9f9fb;} "
        << "table{border-collapse: collapse; width: 100%; margin-bottom: 30px; box-shadow: 0 2px 8px rgba(0,0,0,0.1); background-color:#fff;} "
